...
public class TransactionListenerImpl implements TransactionListener {
    ...
    public LocalTransactionState executeLocalTransaction(Message msg, Object arg) {
        ...
        System.out.println("executeLocalTransaction: " + msg.getKeys() + ",excute state: " + state + ",current time: " + DateUtils.formatLocalDateTime(LocalDateTime.now()));
        return state;
    }
    ...
    public LocalTransactionState checkLocalTransaction(MessageExt msg) {
        System.out.println("checkLocalTransaction message key: " + msg.getKeys() + ",current time: " + DateUtils.formatLocalDateTime(LocalDateTime.now()));
